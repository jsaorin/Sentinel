import { BodyValidator, QueryValidator } from "@sentinel/common/middlewares";
...
import { ListProposalsQuerySchema } from "./dtos/ListProposalsQueryParams.js";
...
router.get(
	...
	QueryValidator.validate(logger, ListProposalsQuerySchema),
